...
{
    private IPoint vertex1, vertex2, vertex3;

    public Triangle(IPoint vertex1, IPoint vertex2, IPoint vertex3)
    {
...
class Program
{
    static void Main()
    {
        ...
        IPoint vertex1 = ReadPoint("Точка 1");
        IPoint vertex2 = ReadPoint("Точка 2");
        IPoint vertex3 = ReadPoint("Точка 3");

        IShape triangle = new Triangle(vertex1, vertex2, vertex3);
        Console.WriteLine("Площа трикутника: " + triangle.GetArea());
    }

    static IPoint ReadPoint(string pointName)
    {
